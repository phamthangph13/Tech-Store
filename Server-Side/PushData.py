...
sample_products = [
    {
        ...
        "category": "robots",
        "type": "Objects",
        "image": "https://homematic.vn/wp-content/uploads/2021/04/homematic.vn_robot-hut-bui-xiaomi-mop-essential1.jpg",
        "icon": "fas fa-robot",
        "isPremium": True,
        "price": 7990000,
        "features": [
    ...
    },
    {
        ...
        "category": "robots",
        "type": "Objects",
        "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuXXk_lIKiXz4BY4TqlgCKbr5g5loxGhnRTg&s",
        "icon": "fas fa-broom",
        "isPremium": True,
        "price": 8990000,
        "features": [
